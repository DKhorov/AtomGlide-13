  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1.5, ml: 1, mt: 0.5 }}>
      <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
        <Avatar
          src={getAvatarUrl()}
          sx={{ width: 49, height: 49, mr: 1, cursor: 'pointer', backgroundColor: 'rgb(78, 78, 78)', border: 'solid rgba(86, 86, 86, 1px)' }}
        ...
        <Box sx={{ ml: 0.2 }}>
          <Typography
            variant="subtitle2"
            sx={{ fontSize: '18px', fontWeight: '700', color: 'rgba(218, 218, 218, 1)', cursor: 'pointer', fontFamily: 'sf' }}
            onClick={() => user._id && navigate(`/account/${user._id}`)}
          >
